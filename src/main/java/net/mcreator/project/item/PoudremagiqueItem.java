...
public class PoudremagiqueItem extends ProjectModElements.ModElement {
	@ObjectHolder("project:poudremagique")
	public static final Item block = null;
	public PoudremagiqueItem(ProjectModElements instance) {
		super(instance, 61);
	}
