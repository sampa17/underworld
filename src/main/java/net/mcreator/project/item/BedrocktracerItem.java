...
public class BedrocktracerItem extends ProjectModElements.ModElement {
	@ObjectHolder("project:bedrocktracer")
	public static final Item block = null;
	public BedrocktracerItem(ProjectModElements instance) {
		super(instance, 1);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Pour acc\u00E9der \u00E0 l'Underworld ."));
			}
		}.setRegistryName("bedrocktracer"));
	}
