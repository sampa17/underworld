...
public class TitanehammerItem extends ProjectModElements.ModElement {
	@ObjectHolder("project:titanehammer")
	public static final Item block = null;
	public TitanehammerItem(ProjectModElements instance) {
		super(instance, 36);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Pour casser la bedrock . [ Left Click ]"));
			}
		}.setRegistryName("titanehammer"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(TabmodItemGroup.tab).maxDamage(100));
		}
