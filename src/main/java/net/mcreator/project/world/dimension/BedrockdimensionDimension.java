...
package net.mcreator.project.world.dimension;
...
import net.mcreator.project.block.UnderwaterBlock;
...
public class BedrockdimensionDimension extends ProjectModElements.ModElement {
	@ObjectHolder("project:bedrockdimension")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public BedrockdimensionDimension(ProjectModElements instance) {
		super(instance, 4);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("bedrockdimension"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("project:bedrockbiome")),};
	}
		...
		public ChunkProviderModded(World world, BiomeProvider provider) {
			super(world, provider, new NetherGenSettings() {
				...
				public BlockState getDefaultFluid() {
					return UnderwaterBlock.block.getDefaultState();
				}
			});
