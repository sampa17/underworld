...
package net.mcreator.project.world.structure;
...
public class ChampiStructure extends ProjectModElements.ModElement {
	public ChampiStructure(ProjectModElements instance) {
		super(instance, 75);
	}
