...
public class TitaneblocBlock extends ProjectModElements.ModElement {
	@ObjectHolder("project:titanebloc")
	public static final Block block = null;
	public TitaneblocBlock(ProjectModElements instance) {
		super(instance, 33);
	}
