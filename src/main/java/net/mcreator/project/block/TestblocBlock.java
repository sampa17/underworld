...
public class TestblocBlock extends ProjectModElements.ModElement {
	@ObjectHolder("project:testbloc")
	public static final Block block = null;
	public TestblocBlock(ProjectModElements instance) {
		super(instance, 1);
	}
