...
public class PlantchampBlock extends ProjectModElements.ModElement {
	@ObjectHolder("project:plantchamp")
	public static final Block block = null;
	public PlantchampBlock(ProjectModElements instance) {
		super(instance, 69);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Clique droit avec bone meal ."));
		}
