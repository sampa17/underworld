...
public class UnderstoneBlock extends ProjectModElements.ModElement {
	@ObjectHolder("project:understone")
	public static final Block block = null;
	public UnderstoneBlock(ProjectModElements instance) {
		super(instance, 2);
	}
