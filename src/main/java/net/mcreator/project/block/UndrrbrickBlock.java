...
public class UndrrbrickBlock extends ProjectModElements.ModElement {
	@ObjectHolder("project:undrrbrick")
	public static final Block block = null;
	public UndrrbrickBlock(ProjectModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.1f, 11f).lightValue(0));
			setRegistryName("undrrbrick");
		}
