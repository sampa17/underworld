...
public class TitanebarrierBlock extends ProjectModElements.ModElement {
	@ObjectHolder("project:titanebarrier")
	public static final Block block = null;
	public TitanebarrierBlock(ProjectModElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			return VoxelShapes.create(0D, 0D, 0D, 0.1D, 1D, 1D);
		}
