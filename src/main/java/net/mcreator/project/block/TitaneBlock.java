...
public class TitaneBlock extends ProjectModElements.ModElement {
	@ObjectHolder("project:titane")
	public static final Block block = null;
	public TitaneBlock(ProjectModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(1.2f, 20f).lightValue(0));
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(IngottitaneItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("titane", "titane", blockAt -> {
